//! This library decodes and encodes blueprint exchange strings
//! generated by the Desynced game.
//!
...
//! this library will always try to comress and will use compressed
//! variant if it is shorter
//! (which is usually false for shorter blueprints).
//! (The game seems to follow a similar strategy.)
//!
//! ## Lua data types
//!
